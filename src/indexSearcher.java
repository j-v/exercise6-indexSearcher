...
public class indexSearcher {
	...
	public static void main(String[] args) throws Exception {
		String usage = "Usage:\njava -jar indexSearcher -index dir [-field f] [-repeat n] [-queries file] [-query string] [-raw] [-paging hitsPerPage]";
		if (args.length > 0
	...
	public static void doPagingSearch(BufferedReader in,
		IndexSearcher searcher, Query query, int hitsPerPage, boolean raw, boolean interactive) throws IOException {
